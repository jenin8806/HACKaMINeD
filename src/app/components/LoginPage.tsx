      ...
      >
        ...
        <div className="bg-[#0A1520]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-2">
            <h2 className="text-xl font-semibold text-[#E8E9E8]">Welcome back</h2>
            <p className="text-sm text-[#E8E9E8]/50 mt-1">Sign in to continue to your dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-8 pb-8 pt-4 space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className="text-xs text-[#E8E9E8]/50 group-hover:text-[#E8E9E8]/70 transition-colors select-none">
                  Remember me
                </span>
              </label>
              <button type="button" className="text-xs text-[#C7F711]/70 hover:text-[#C7F711] transition-colors">
                Forgot password?
              </button>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-[#0A1520] text-[#E8E9E8]/30">or continue with</span>
              </div>
            </div>
          ...
          <div className="px-8 py-5 border-t border-white/5 bg-[#070f18]/50 text-center">
            <p className="text-sm text-[#E8E9E8]/40">
              ...
              <Link to="/signup" className="text-[#C7F711] hover:text-[#A9F42C] font-medium transition-colors">
                Create one
              </Link>
            </p>
          </div>
