...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── First viewport: title + buttons + SCROLL ── */}
      <div className="relative z-10 h-screen flex flex-col">
        {/* Centered hero content */}
        <div className="flex-1 flex flex-col items-center justify-center text-center w-full max-w-5xl mx-auto px-6 lg:px-8 pt-36">
          <motion.h1
        ...
        {/* SCROLL — pinned to bottom of first viewport */}
        <motion.div
        ...
        >
          ...
          >
            <span className="text-[10px] text-[#E8E9E8]/35 tracking-[0.28em] uppercase">Scroll</span>
            <div className="w-px h-8 bg-gradient-to-b from-[#C7F711]/50 to-transparent" />
          </motion.div>
        </motion.div>
      </div>

      {/* ── Stats — below fold, still inside hero ── */}
      <motion.div
        className="relative z-10 flex justify-center items-center gap-0 py-16"
        ...
        {[
          ...
          <div key={i} className="flex items-center">
            <div className="text-center px-12">
              <div
                className="font-orbitron text-3xl md:text-4xl font-bold text-[#C7F711] flex items-center justify-center tracking-wider"
                style={{ textShadow: "0 0 22px rgba(199,247,17,0.5)" }}
              >
                <CountUp from={0} to={stat.num} duration={2} />
                <span>{stat.suffix}</span>
              </div>
              <div className="text-[11px] text-[#E8E9E8]/40 mt-2 tracking-[0.2em] uppercase">{stat.label}</div>
            </div>
